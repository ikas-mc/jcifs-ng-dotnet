...
using NdrSmall = jcifs.dcerpc.ndr.NdrSmall;
...
namespace jcifs.dcerpc.msrpc {
	...
	public class lsarpc {
		...
		public const int POLICY_INFO_AUDIT_EVENTS = 2;
		public const int POLICY_INFO_PRIMARY_DOMAIN = 3;
		public const int POLICY_INFO_ACCOUNT_DOMAIN = 5;
		public const int POLICY_INFO_SERVER_ROLE = 6;
		public const int POLICY_INFO_MODIFICATION = 9;
		public const int POLICY_INFO_DNS_DOMAIN = 12;
		...
		public const int SID_NAME_USE_NONE = 0;
		public const int SID_NAME_USER = 1;
		public const int SID_NAME_DOM_GRP = 2;
		public const int SID_NAME_DOMAIN = 3;
		public const int SID_NAME_ALIAS = 4;
		public const int SID_NAME_WKN_GRP = 5;
		public const int SID_NAME_DELETED = 6;
		public const int SID_NAME_INVALID = 7;
		public const int SID_NAME_UNKNOWN = 8;
		...
		public class LsarLookupSids : DcerpcMessage {
			...
			public LsarLookupSids(rpc.policy_handle handle, LsarSidArray sids, LsarRefDomainList domains, LsarTransNameArray names, short level, int count) {
				this.handle = handle;
				this.sids = sids;
