...
namespace jcifs.config {
	...
	/// 
	/// </summary>
	public sealed class PropertyConfiguration : BaseConfiguration, Configuration {

		/// <param name="p">
		///            read from properties </param>
		...
		public PropertyConfiguration(Properties p) {
			...
			this.nativeOs = p.getProperty("jcifs.smb.client.nativeOs", RuntimeHelp.getOsName());
			...
			this.winsServer = Config.getInetAddressArray(p, "jcifs.netbios.wins", ",", new IPAddress[0]);
			...
			if (minVer != null || maxVer != null) {
				...
				bool smb2 = Config.getBoolean(p, "jcifs.smb.client.enableSMB2", true);
				bool nosmb1 = Config.getBoolean(p, "jcifs.smb.client.disableSMB1", false);
