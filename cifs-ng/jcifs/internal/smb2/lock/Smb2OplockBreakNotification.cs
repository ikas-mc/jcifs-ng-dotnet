...
namespace jcifs.@internal.smb2.@lock {
	...
	/// 
	/// </summary>
	public class Smb2OplockBreakNotification : ServerMessageBlock2Response {
		...
		public Smb2OplockBreakNotification(Configuration config) : base(config) {
		}
		...
		/// {@inheritDoc}
		/// </summary>
		/// <seealso cref= jcifs.internal.smb2.ServerMessageBlock2#toString() </seealso>
