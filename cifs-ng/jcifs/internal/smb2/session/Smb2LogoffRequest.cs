...
namespace jcifs.@internal.smb2.session {
	...
	/// 
	/// </summary>
	public class Smb2LogoffRequest : ServerMessageBlock2Request<Smb2LogoffResponse> {

		/// <param name="config"> </param>
		public Smb2LogoffRequest(Configuration config) : base(config, SMB2_LOGOFF) {
		}


		protected  override Smb2LogoffResponse createResponse(CIFSContext tc, ServerMessageBlock2Request<Smb2LogoffResponse> req) {
