...
namespace jcifs.@internal.smb1.com {
	...
	/// 
	public class SmbComCreateDirectory : ServerMessageBlock {

		/// 
		/// <param name="config"> </param>
		/// <param name="directoryName"> </param>
		public SmbComCreateDirectory(Configuration config, string directoryName) : base(config, SMB_COM_CREATE_DIRECTORY, directoryName) {
		}
		...
		public override string ToString() {
			return "SmbComCreateDirectory[" + base.ToString() + ",directoryName=" + this.path + "]";
		}
	}
