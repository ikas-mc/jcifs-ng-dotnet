...
namespace jcifs.@internal.smb1.com {
	...
	/// 
	/// </summary>
	public class SmbComSetInformationResponse : ServerMessageBlock {

		/// 
		/// <param name="config"> </param>
		public SmbComSetInformationResponse(Configuration config) : base(config) {
		}
		...
		public override string ToString() {
			return "SmbComSetInformationResponse[" + base.ToString() + "]";
		}
	}
