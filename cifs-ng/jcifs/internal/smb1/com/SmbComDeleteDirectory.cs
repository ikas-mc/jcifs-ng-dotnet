...
namespace jcifs.@internal.smb1.com {
	...
	/// 
	public class SmbComDeleteDirectory : ServerMessageBlock {

		/// 
		/// <param name="config"> </param>
		/// <param name="path"> </param>
		public SmbComDeleteDirectory(Configuration config, string path) : base(config, SMB_COM_DELETE_DIRECTORY, path) {
		}
		...
		public override string ToString() {
			return "SmbComDeleteDirectory[" + base.ToString() + ",directoryName=" + this.path + "]";
		}
	}
