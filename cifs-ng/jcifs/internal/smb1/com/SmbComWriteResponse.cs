...
namespace jcifs.@internal.smb1.com {
	...
	/// 
	public class SmbComWriteResponse : ServerMessageBlock {
		...
		public SmbComWriteResponse(Configuration config) : base(config) {
		}
		...
		public override string ToString() {
			return "SmbComWriteResponse[" + base.ToString() + ",count=" + this.count + "]";
		}
	}
