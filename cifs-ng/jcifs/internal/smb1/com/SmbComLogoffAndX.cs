...
namespace jcifs.@internal.smb1.com {
	...
	/// 
	public class SmbComLogoffAndX : AndXServerMessageBlock {

		/// 
		/// <param name="config"> </param>
		/// <param name="andx"> </param>
		public SmbComLogoffAndX(Configuration config, ServerMessageBlock andx) : base(config, SMB_COM_LOGOFF_ANDX, andx) {
		}
